...
def juego_ahorcado():
    ...
    while not juego_terminado and intentos > 0:
        ...
        if len(adivinanza) != 1 or not adivinanza.isalpha():
            print("Por favor, solo puedes ingresar letras y una a la vez")
        elif adivinanza in letras_adivinadas:
            print("Ya utilizaste esa letra, prueba con otra")
        else:
    ...
    if intentos == 0:
        palabra_secreta = palabra_secreta.capitalize()
        print(f"lo siento se te acabo los intentos, la palabra secreta era: '{palabra_secreta}'")
